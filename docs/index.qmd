...
seafloor <- hbk %>%
  filter(!is.na(Seafloor_Morphology)) %>%
  select(datetime_UTC, datetime_AST, Latitude, Longitude, Seafloor_Morphology, Glider_depth_m, Salinity_PSU, Oxygen_concentration_µmol_L, RASTERDEPTH_m, RASTERSLOPE_deg, NEAR_DIST_m, Nearest_Shoreline)

# Print list of all unique values in Seafloor_Morphology col
print(unique(seafloor$Seafloor_Morphology))
#  [1] "Abyss; Abyssal mountain; Basin (large); Escarpment; Trough"  
    # 
#  [2] "Abyss; Abyssal mountain; Basin (large); Trough"                       
#  [3] "Escarpment; Slope"                                                    
#  [4] "Abyss; Abyssal mountain; Escarpment"                                  
#  [5] "Basin (large); Escarpment; Slope"                                     
#  [6] "Slope"                                                                
#  [7] "Slope; Terrace"                                                       
#  [8] "Abyss; Abyssal mountain; Basin (large); Rise"                         
#  [9] "Abyss; Abyssal mountain; Basin (large); Canyon (shelf incising); Rise"
# [10] "Abyss; Abyssal mountain; Basin (large); Escarpment; Rise"             
# [11] "Abyss; Abyssal mountain; Canyon (shelf incising); Escarpment; Rise"   
# [12] "Canyon (blind); Escarpment; Slope"                                    
# [13] "Basin (large); Escarpment; Slope; Trough"
...
# Abyss = Basin (an ocean basin refers to the entire large depression that holds ocean water, while the abyssal plain (or abyss) is a specific, very flat, deep region within that basin)
